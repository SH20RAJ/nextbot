  ...
  "response": [
    {
      ...
      bot.sendPhoto(chatId, data.response[0].thumbnail, {
        caption: `Title: ${data.response[0].title}
  \nFast Download: ${data.response[0].resolutions["Fast Download"]}
  \nHD Video: ${data.response[0].resolutions["HD Video"]}
  \n\nWatch Link: ${watchlink}
  \n\nShare this bot to keep this bot Working and Join @sopbots
